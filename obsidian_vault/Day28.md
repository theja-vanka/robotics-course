...
> **Phase:** 🎯 Phase 4 — Interview Mastery + Second Product  ·  **📅 Week 5 · Thu**
...
| 9:30–11:00 | 🧠 **New Concept** | 🤖 Gap fill day | - [ ] Done |
| 11:00–11:15 | ☕ Break | — | — |
| 11:15–13:00 | 🛠️ **Hands-on** | 🤖 apply it → capstone | - [ ] Done |
| 13:00–14:00 | 🍽️ Lunch | Step away from screens | — |
| 14:00–15:30 | 🔧 **Build + Milvus** | 🗄️ Milvus weakness fix | - [ ] Done |
| 15:30–15:45 | ☕ Break | — | — |
| 15:45–17:15 | 🗜️ **Compression** | 🗜️ Compression weakness | - [ ] Done |
| 17:15–18:30 | 🔁 Capstone Lab | extra fine-tune / compress / eval reps | - [ ] Done |
| 18:30–19:00 | 🍵 Dinner | Step away | — |
| 19:00–20:30 | 🧩 **DSA** | Weak-area drill | - [ ] Done |
...
**🎯 Today's focus:**
- 🤖 AI/Robotics: Gap fill day
- 🗄️ Milvus *(supporting tool)*: Milvus weakness fix
- 🗜️ Compression: Compression weakness
- 🔁 Capstone Lab *(reps on the capstone)*: extra fine-tune / compress / eval reps
- 🧩 DSA: Weak-area drill

**🤖 Capstone today →** Gap-fill — fix the weakest part of `vla-edge` from your mock feedback.
...
## 🌅 Warm-up | 9:00–9:30 | Debrief
**Task:** Pull Day 25 weakness list. Rank by priority.
...
---
## 🧠 New Concept | 9:30–11:00 | Weakness #1
**Task:** 2-hour deep dive: read, implement, test, re-explain to yourself.
...
---
## 🛠️ Hands-on | 11:15–13:00 | Weakness #2
**Task:** 2-hour deep dive on second weakest topic.
...
---
## 🔧 Build + Milvus | 14:00–15:30 | Weakness #3
**Task:** Final 2-hour deep dive.
...
---
## 🗜️ Compression | 15:45–17:15 | Weakness Fix
**Task:** Re-study your lowest-scoring compression topic. Rerun the experiment.
...
**Task:** Deliberate-practice reps on the capstone: Gap-fill — fix the weakest part of `vla-edge` from your mock feedback. Re-run it, change ONE variable (LoRA rank, precision, prompt, batch), measure the effect, and log a number to vla-edge/benchmarks/results.csv.
...
**Step 5.** Do the reps: Deliberate-practice reps on the capstone: Gap-fill — fix the weakest part of `vla-edge` from your mock feedback. Re-run it, change ONE variable (LoRA rank, precision, prompt, batch), measure the effect, and log a number to vla-edge/benchmarks/results.csv.
...
---
## 🧩 DSA | 19:00–20:30 | Weak-area drill
**Task:** Name the pattern, then solve 3–5 Weak-area drill problems. Test edge cases, state time/space complexity, and queue the hardest to re-solve from memory tomorrow.

**🎯 Outcome:** A few DSA — Weak-area drill problems solved cold, with the pattern named.
...
**Step 2.** Pick **3–5** problems on today's pattern (**Weak-area drill**).
