# Day 25 — Mock Interview #2 (Full Simulation)

> **Phase:** 🎯 Phase 4 — Interview Mastery + Second Product  ·  **📅 Week 5 · Mon**
...
| 9:30–11:00 | 🧠 **New Concept** | 🤖 Mock interview #2 | - [ ] Done |
| 11:00–11:15 | ☕ Break | — | — |
| 11:15–13:00 | 🛠️ **Hands-on** | 🤖 apply it → capstone | - [ ] Done |
| 13:00–14:00 | 🍽️ Lunch | Step away from screens | — |
| 14:00–15:30 | 🔧 **Build + Milvus** | 🗄️ Milvus + compression mock | - [ ] Done |
| 15:30–15:45 | ☕ Break | — | — |
| 15:45–17:15 | 🗜️ **Compression** | 🗜️ Full simulation | - [ ] Done |
| 17:15–18:30 | 🔁 Capstone Lab | extra fine-tune / compress / eval reps | - [ ] Done |
| 18:30–19:00 | 🍵 Dinner | Step away | — |
| 19:00–20:30 | 🧩 **DSA** | DP on subsequences (LIS / LCS) | - [ ] Done |
...
**🎯 Today's focus:**
- 🤖 AI/Robotics: Mock interview #2
- 🗄️ Milvus *(supporting tool)*: Milvus + compression mock
- 🗜️ Compression: Full simulation
- 🔁 Capstone Lab *(reps on the capstone)*: extra fine-tune / compress / eval reps
- 🧩 DSA: DP on subsequences (LIS / LCS)

**🤖 Capstone today →** Mock #2 — defend the capstone out loud (architecture, fine-tune, compression).
...
**⏱️ Estimated resource time today:** ~220 min (~3.7 hr)

---

## 🌅 Warm-up | 9:00–9:30 | Final Review
**Task:** Speed-run all flashcards from Days 1–24.
...
---
## 🧠 New Concept | 9:30–11:00 | Mock — Theory (90 min)
**Task:** Claude quizzes you across all topics. Score yourself 1–5 per question.

**🎯 Outcome:** A written artifact (summary + from-memory sketch) that proves you understand Mock — Theory (90 min).

**▶️ DO THIS — every step (read in browser → write in Obsidian):**

**Step 1.** Click the first resource below (**ML Interview Q&A — Chip Huyen**) — it opens in your browser.
**Step 2.** Read it for ~15 min. You don't need every word — get the big picture and the main diagram.
**Step 3.** In Obsidian, make a new note (click the 📄 **New note** icon, name it `Day 25 — notes`).
**Step 4.** With the article **closed**, write 5–8 sentences explaining **Mock — Theory (90 min)** in your own words, and sketch the main flow.
...
**✅ Done when:**
- [ ] You can explain Mock — Theory (90 min) aloud in ~2 min with notes closed
...
**Task:** Implement IoU + NMS live, or attention from scratch. Time yourself.
...
**Step 2.** Do it under time pressure: Implement IoU + NMS live, or attention from scratch. Time yourself.
...
---
## 🔧 Build + Milvus | 14:00–15:30 | Mock — System Design (45 min)
**Task:** 'Design a synthetic data pipeline to teach a robot a new skill.' 45-min timed.
...
**Step 1.** Set a timer. Open a blank Obsidian note. No notes open, no Googling.
**Step 2.** Do it under time pressure: 'Design a synthetic data pipeline to teach a robot a new skill.' 45-min timed.
**Step 3.** Score each answer **1–5** the moment you finish it.
**Step 4.** Write your weakest 2–3 areas as today's fix-list. Tick ✅ and check **Block complete**.
...
---
## 🗜️ Compression | 15:45–17:15 | Mock — Milvus + Compression
**Task:** 'Design a vector DB schema for a robot pipeline' + 'INT8 vs 4-bit on Jetson trade-offs'.
...
**Step 1.** Set a timer. Open a blank Obsidian note. No notes open, no Googling.
**Step 2.** Do it under time pressure: 'Design a vector DB schema for a robot pipeline' + 'INT8 vs 4-bit on Jetson trade-offs'.
**Step 3.** Score each answer **1–5** the moment you finish it.
**Step 4.** Write your weakest 2–3 areas as today's fix-list. Tick ✅ and check **Block complete**.
...
**Task:** Deliberate-practice reps on the capstone: Mock #2 — defend the capstone out loud (architecture, fine-tune, compression). Re-run it, change ONE variable (LoRA rank, precision, prompt, batch), measure the effect, and log a number to vla-edge/benchmarks/results.csv.
...
**Step 5.** Do the reps: Deliberate-practice reps on the capstone: Mock #2 — defend the capstone out loud (architecture, fine-tune, compression). Re-run it, change ONE variable (LoRA rank, precision, prompt, batch), measure the effect, and log a number to vla-edge/benchmarks/results.csv.
...
---
## 🧩 DSA | 19:00–20:30 | DP on subsequences (LIS / LCS)
**Task:** Name the pattern, then solve 3–5 DP on subsequences (LIS / LCS) problems. Test edge cases, state time/space complexity, and queue the hardest to re-solve from memory tomorrow.

**🎯 Outcome:** A few DSA — DP on subsequences (LIS / LCS) problems solved cold, with the pattern named.
...
**Step 2.** Pick **3–5** problems on today's pattern (**DP on subsequences (LIS / LCS)**).
