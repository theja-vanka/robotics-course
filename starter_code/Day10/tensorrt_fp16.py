...
HOW TO USE THIS FILE:
  ...
  2. Check yourself:   pytest tensorrt_fp16.py     (or just:  python tensorrt_fp16.py)
...
# ════ TESTS — run `pytest tensorrt_fp16.py` (or `python tensorrt_fp16.py`). All green = you're done. ════
