...
HOW TO USE THIS FILE:
  ...
  2. Check yourself:   pytest pruning_hands_on.py     (or just:  python pruning_hands_on.py)
...
# ════ TESTS — run `pytest pruning_hands_on.py` (or `python pruning_hands_on.py`). All green = you're done. ════
