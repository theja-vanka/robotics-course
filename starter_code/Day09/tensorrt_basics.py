...
HOW TO USE THIS FILE:
  ...
  2. Check yourself:   pytest tensorrt_basics.py     (or just:  python tensorrt_basics.py)
...
# ════ TESTS — run `pytest tensorrt_basics.py` (or `python tensorrt_basics.py`). All green = you're done. ════
