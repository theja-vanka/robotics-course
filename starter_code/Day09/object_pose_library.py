...
HOW TO USE THIS FILE:
  ...
  2. Check yourself:   pytest object_pose_library.py     (or just:  python object_pose_library.py)
...
# ════ TESTS — run `pytest object_pose_library.py` (or `python object_pose_library.py`). All green = you're done. ════
